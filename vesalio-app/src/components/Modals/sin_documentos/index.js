    ...
    const datosPersonalesSiguiente = async () => {
        ...
        if (textPersonales.filter(x => x.value.length === 0 && x.step === step).length > 0 && busca.numerodocumento.length === 0) {
            ...
            if (busca.tipodocumento === '02' && busca.numerodocumento.length !== 9) {
                errors.push('El Carné de extranjeria solo debe contener 8 digitos')
            }
            ...
            <Box sx={{ p: 2 }}>
...

                {
                    step === 0 && <>
                        ...
                        <DatosPersonales textPersonales={textPersonales.filter(x => x.step === step)} />
                    </>
                }
                {
                    ...
                    step === 2 && <Box px={4} py={8}>
                        <Container maxWidth="sm">
                            ...
                            <Collapse in={openAlert}>
                                ...
                                >
                                    {t(
                                        'Las credenciales de acceso se les enviara al metodo de autentificación que selecciono'
                                    )}
                                </Alert>
                            </Collapse>
