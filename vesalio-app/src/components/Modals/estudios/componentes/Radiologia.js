            ...
            <Grid container spacing={1} sx={{ my: 1, pb: 3, px: 2, mt: 2 }} >
                ...
                <Grid item lg={12} sx={{ mx: 2 }}>
                    ...
                    <TextField
                        ...
                        rows={3}
                        type={'text'}
                        value={text.find(x => x.id === 'infRadiologia').text}
                        variant="outlined"
                        onChange={(e) => handleChangedTextState(e.target.value, 'infRadiologia')}
                    />
                </Grid>
                <Grid item lg={12} sx={{ mx: 2 }}>
                    ...
                    <TextField
                        ...
                        rows={3}
                        type={'text'}
                        value={text.find(x => x.id === 'impRadiologia').text}
                        variant="outlined"
                        onChange={(e) => handleChangedTextState(e.target.value, 'impRadiologia')}
                    />
                </Grid>
            </Grid>
