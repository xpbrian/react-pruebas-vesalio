...
export default function Patologia({handleGuardarCheck, seleccionados, selected, setSeleccionados, text, handleChangedTextState }) {
            ...
            <Grid container spacing={1} sx={{ my: 1, pb: 3, px: 2, mt: 2 }} >
                ...
                <Grid item lg={12} sx={{ mx: 2 }}>
                    ...
                    <TextField
                        ...
                        rows={3}
                        type={'text'}
                        value={text.find(x => x.id === 'infPatologia').text}
                        variant="outlined"
                        onChange={(e) => handleChangedTextState(e.target.value, 'infPatologia')}
                    />
                </Grid>
                <Grid item lg={12} sx={{ mx: 2 }}>
                    ...
                    <TextField
                        ...
                        rows={3}
                        type={'text'}
                        value={text.find(x => x.id === 'impPatologia').text}
                        variant="outlined"
                        onChange={(e) => handleChangedTextState(e.target.value, 'impPatologia')}
                    />
                </Grid>
            </Grid>
