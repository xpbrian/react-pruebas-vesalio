...
export default function ListaCitasTabla({ lista: datos }) {
    ...
    const handleRemove = async (id) => {
        ...
        if (confirm) {
            ...
            const response = await axios.post(`http://200.121.91.211:4001/removeAntecedenteHeredoFamiliar`, { ...obj })
            if (typeof response.data === 'object') {
                ...
                drawerOpen.item.setDatosAntecedentes('heredo')
            }
        ...
        <>
            ...
            <TableContainer>
                <Table ref={tableRef}>
                    <TableHead>
                        <TableRow>
                            <TableCell>{t('Diagnóstico')}</TableCell>
                            <TableCell>{t('Familiar')}</TableCell>
