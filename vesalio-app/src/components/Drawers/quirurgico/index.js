...
export default function Index() {
    ...
    return (
        <>
                    ...
                    <Button
                        ...
                        onClick={() => mostrarComponent({
                            ...
                            item: {
                                ...
                                setDatosAntecedentes: () => drawerOpen.item.setDatosAntecedentes('quirurgico')
                            }
                        }, 'modalOpen')}
                        startIcon={<AddIcon />}>
                        Agregar
            ...
            <Grid container spacing={1} sx={{ my: 1 }}>
                <Grid item lg={12} sx={{ mr: 2 }}>
                    {lista.length === 0 && <Box sx={{ m: 3 }}><Typography variant='h4'>No registra antecedentes quirurgicos</Typography></Box>}
