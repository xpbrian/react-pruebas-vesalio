import { Accordion, AccordionDetails, Autocomplete, Button, Divider, Grid, TextField, Zoom } from '@mui/material'
...
export default function PorFecha({ enviar, especialidadSelected, fechaSelected, pacienteWsp }) {
  const { user } = useAuth()
