...
export default function AlergiasCard({ oxigeo, nebu, texto, id }) {
    ...
    return (
        ...
        >
            <Grid item lg={6} sx={{ mt: .4 }}>
                <TextField variant="outlined" label={"Oxigenoterapia"} disabled fullWidth value={oxigeo} />
            </Grid>
            <Grid item lg={6} sx={{ mt: .4 }}>
                <TextField variant="outlined" disabled fullWidth label={"Nebulizacion"} value={nebu} />
            </Grid>
            <Grid item lg={12} sx={{ mt: .4 }}>
                <Typography variant="h4">Observaciones</Typography>
                <Markup content={texto} />
            </Grid>
