...
export default function AlergiasCard({ dieta, alimentacion, consistencia, id }) {
    ...
    return (
        ...
        >
            <Grid item lg={6} sx={{ mt: .4 }}>
                <TextField variant="outlined" label={"Dieta"} disabled fullWidth value={dieta} />
            </Grid>
            <Grid item lg={6} sx={{ mt: .4 }}>
                <TextField variant="outlined" disabled fullWidth label={"Consistencia"} value={consistencia} />
            </Grid>
            <Grid item lg={6} sx={{ mt: .4 }}>
                <Typography variant="h4">Alimentación</Typography>
                <Markup content={alimentacion} />
            </Grid>
