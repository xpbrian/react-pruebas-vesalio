...
export default function AlergiasCard({ precauciones, indicaciones, id }) {
    ...
    return (
        ...
        >
            <Grid item lg={6} sx={{ mt: .4 }}>
                <TextField variant="outlined" label={"Indicaciones"} disabled fullWidth value={indicaciones} />
            </Grid>

            <Grid item lg={12} sx={{ mt: .4 }}>
                <Typography variant="h4">Precauciones</Typography>
                <Markup content={precauciones} />
            </Grid>
            <Grid item lg={12}>
                <Divider />
            </Grid>
