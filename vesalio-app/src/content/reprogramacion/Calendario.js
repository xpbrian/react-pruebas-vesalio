...
export default function CalendarioAgenda({tipo,agignacionSelecteds,datos}) {
    ...
    return (
        <Card >
            ...
            <Divider />
            <CalendarioItem calendario={calendario} tipo={tipo} agignacionSelecteds={agignacionSelecteds} datos={datos} />
        </Card>
