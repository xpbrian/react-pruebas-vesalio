...
export default function CalendarioAgenda({ asignacionSelected,setAsignacionSelected }) {
    ...
    return (
        <Card >
            ...
            <Divider />
            <CalendarioItem calendario={calendario} asignacionSelected={asignacionSelected} setAsignacionSelected={setAsignacionSelected}/>
        </Card>
