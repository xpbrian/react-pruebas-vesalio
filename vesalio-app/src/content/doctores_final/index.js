...
import Calendario from './PorEspecialidad/Calendario'
...
export default function Index() {
    ...
    useEffect(() => {
        console.log(agignacionSelecteds);
    }, [agignacionSelecteds])
            ...
            >
                ...
                </Grid>
                {
                    mostrar && <Grid item lg={4}>
                        ...
                        {
                            tabs.find(x => x.active).value === '01' ? <PorEspecialidad setAsignacionSelecteds={setAsignacionSelecteds} getDatosMedicoSelected={getDatosMedicoSelected} agignacion={agignacion} /> : <PorMedico agignacion={agignacion} />
                        }
                    </Grid>
                }
                {
                    mostrar && <Grid item lg={8}>
                        {
                            tabs.find(x => x.active).value === '01' ? <Calendario agignacionSelecteds = {agignacionSelecteds}/> : ""
                        }
