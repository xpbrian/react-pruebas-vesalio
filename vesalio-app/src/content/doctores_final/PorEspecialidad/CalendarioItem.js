...
import ContenidoCalendario from './ContenidoCalendario';

export default function CalendarCitas({ calendario, agignacionSelecteds }) {
                                    ...
                                    {construir.map((x, ix) =>
                                        ...
                                        <Card key={ix} style={{ width: "350px", textAlign: "center", minHeight: "220px", borderRadius: "0" }}>
                                            <Box>
                                                {
                                                    x.semanas.map((y, iX) =>
                                                        <Card key={iX} style={{ background: 'white', padding: "0px", textAlign: "center", maxHeight: "220px", margin: "5px 10px 10px -5px" }}>
                                                            {
                                                                y.existe && <>
                                                                    ...
                                                                    <Box style={{ minHeight: "220px"}}>
                                                                        <ContenidoCalendario item={y} agignacionSelecteds={agignacionSelecteds} />
                                                                    </Box>
                                                                </>
                                                            }
